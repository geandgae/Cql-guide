<template>
  ...
  <v-container fluid class="pa-10">
    ...
    <v-table class="flex-grow-1">
      <thead>
        <tr>
          <th v-for="(item, i) in th" :key="i" class="text-center">
            {{ item.title }}
          </th>
        </tr>
      </thead>
  ...
  data() {
    return {
      ...
      td: [
        ...
        {
          type: "",
          name: "09.구독현황_나의구독 채널",
          depth1: "dashboard",
          depth2: "subscribe_status_channel",
          depth3: "-",
          url: {
